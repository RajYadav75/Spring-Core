...
public class Main {
	...
	public static void main(String[] args) throws Exception {
		...
		Class<?> clz = Class.forName("in.raj.Car");
...
<beans xmlns="http://www.springframework.org/schema/beans"
	...
	<bean id="petrolEng" class="in.raj.beans.PetrolEngine" />

	<bean id="car" class="in.raj.beans.Car">
...
=> <constructor-arg /> tag represents constructor injection
	...
	<bean id="dieselEng" class="in.raj.beans.DieselEngine" />
...
<beans xmlns="http://www.springframework.org/schema/beans"
	...
	<bean id="eng1" class="in.raj.beans.PetrolEngine" />

	<bean id="eng" class="in.raj.beans.DieselEngine" />

	<bean id="car" class="in.raj.beans.Car" autowire="byName"/>
...
<beans xmlns="http://www.springframework.org/schema/beans"
	...
	<bean id="eng2" class="in.raj.beans.PetrolEngine" autowire-candidate="false"/>

	<bean id="eng1" class="in.raj.beans.DieselEngine" autowire-candidate="true"/>

	<bean id="car" class="in.raj.beans.Car" autowire="byType" />
...
<beans xmlns="http://www.springframework.org/schema/beans"
	...
	<bean id="eng2" class="in.raj.beans.PetrolEngine" primary="true" />

	<bean id="eng1" class="in.raj.beans.DieselEngine"  />

	<bean id="car" class="in.raj.beans.Car" autowire="constructor" />
...
============  Bean Life Cycle using XML Approach ================
	...
	<bean id="motor" class="in.raj.beans.Motor" 
					 init-method="start" 
					 destroy-method="stop"/>
...
=================================================================================================
		...
		basePackage = in.raj
					    ...
					    in.raj.beans --------> will be scanned

					    in.raj.utils ----------> will be scanned

					    in.raj.dao ------> will be scanned

					    com.raj.service --->  will not be scanned
